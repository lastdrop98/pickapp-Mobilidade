      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
        {testimonials.map((testimonial, index) => (
          <ScrollReveal key={testimonial.name} delay={index * 0.1}>
            <div className="card-interactive group bg-card/70 backdrop-blur-md rounded-2xl p-8 shadow-sm border border-border/50 hover:border-accent/40 h-full flex flex-col">
