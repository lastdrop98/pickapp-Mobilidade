...
export const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-20 right-0 w-[500px] h-[500px] bg-accent/8 rounded-full blur-[100px] animate-float-slow" />
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-accent/5 rounded-full blur-[80px] animate-float" />
            ...
            <ScrollReveal direction="left">
              <div className="max-w-xl">
                ...
                <p className="text-lg md:text-xl text-primary-foreground/75 mb-10 leading-relaxed">
                  Viagens seguras, rápidas e com preços justos em Maputo. E
                  agora também entregas de comida, compras, bebidas e farmácia.
                </p>
